    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Scranton Way", "JohnK@email.com", "John", true, "Krasinski" },
                    { 2, "101 Denmark Dn.", "Denmark.Gov", "Mark", true, "Denmark" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "In Ascension", 1, null },
                    { 2, 1, "Children of Time", 2, null },
                    { 3, 2, "A Court of silver Flames", 1, new DateTime(2020, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, 2, "The Golem and the Jinni", 3, new DateTime(2014, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, 3, "The Small and Mighty", 1, null },
                    { 6, 3, "How to Hide an Empire", 2, null },
                    { 7, 4, "Youth to Power", 2, new DateTime(2023, 5, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 8, 5, "Real Crime Detective", 3, new DateTime(2020, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 9, 5, "I'll be Gone in the Dark", 2, null },
                    { 10, 1, "The Splendid and the Vile", 1, null }
                });
